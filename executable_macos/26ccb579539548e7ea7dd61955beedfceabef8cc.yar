rule MacOS_Creddump_KeychainAccess_535c1511_alt_1
{
	meta:
		...
		os = "macos"
		description = "Detects potential malicious activity related to dumping credentials from the macOS Keychain using various methods"
		filetype = "executable"
