...
rule blackmatter_linux_encryptor : Ransomware
{
	...
	condition:
		uint16(0)==0x457f and filesize <5000KB and elf.number_of_sections>30 and for any i in (12..elf.number_of_sections-12) : ((elf.sections[i].name==".app.version") and (elf.sections[i+1].name==".cfgETD")) and any of ($func*) and 3 of ($cc*) and 3 of ($cfg*) and 3 of ($log*) and $tmpFileName and $configDecrypt and $sha1Constants and $cpuidCall and $gettimeofday
}
