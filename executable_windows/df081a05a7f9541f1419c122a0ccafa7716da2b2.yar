rule FormconfB_alt_2
{
	...
	strings:
		...
		$c2_2 = {49 8D 95 [2] 00 00 49 8D 8D [2] 00 00 41 B8 07 00 00 00 E8 [4] 49 8B CD 45 88 [3] 00 00 E8 [4] 33 C0}
		$c2_3 = {49 8B CD 45 88 B5 [4] E8 [4] 33 C0 48 8D 95 [4] 49 8D 8D}
