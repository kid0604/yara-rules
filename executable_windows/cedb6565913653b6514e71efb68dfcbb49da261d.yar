rule malware_donut_shellcode
{
	...
	condition:
		all of them and (( uint8(0)==0x90 and uint32(2)== uint32(6) and uint32( uint32(6)+6)==0x5C894859) or ( uint8(0)==0xE8 and uint32(1)== uint32(5) and uint32( uint32(5)+5)==0x5C894859))
}
