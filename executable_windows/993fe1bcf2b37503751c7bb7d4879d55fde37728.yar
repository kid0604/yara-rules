rule malware_shellcode_hash
{
	...
	condition:
		all of ($addRol5HashOncemore32*) or all of ($imul21hAddHash32*) or all of ($ror7AddHash32*) or all of ($shl7SubHash32DoublePulser*) or all of ($imul83hAdd*) or all of ($xorShr8Hash32*) or all of ($or23hXorRor17Hash32*) or all of ($shl7Shr19XorHash32*) or all of ($rol3XorHash32*) or all of ($ror13AddHash32Sub20h*) or all of ($crc32*) or all of ($chAddRol8Hash32*) or all of ($ror13AddHash32Dll*) or all of ($playWith0xedb88320Hash*) or all of ($rol9AddHash32*) or all of ($crc32_bzip2*) or all of ($ror9AddHash32*) or all of ($ror11AddHash32*) or all of ($rol7AddHash32*) or all of ($ror13AddHash32*) or all of ($ror13AddHash32Sub1*) or all of ($rol3XorEax*) or all of ($xorRol9Hash32*) or all of ($rol9XorHash32*) or all of ($rol5AddHash32*) or all of ($poisonIvyHash*) or all of ($rol7XorHash32*) or all of ($crc32Xor0xca9d4d4e*) or all of ($playWith0xe8677835Hash*) or all of ($addRor13HashOncemore32*) or all of ($shl7Shr19AddHash32*) or all of ($or21hXorRor11Hash32*) or all of ($or60hAddShl1Hash32*) or all of ($addRor13Hash32*) or all of ($rol8Xor0xB0D4D06Hash32*) or all of ($ror13AddHash32DllSimple*) or all of ($shr2Shl5XorHash32*) or all of ($rol5XorHash32*)
}
