...
rule INDICATOR_SUSPICIOUS_Binary_Embedded_Crypto_Wallet_Browser_Extension_IDs_alt_3
{
	...
	strings:
		...
		$s94 = "djclckkglechooblngghdinmeemkbgci" ascii wide nocase
		$s95 = "jnmbobjmhlngoefaiojfljckilhhlhcj" ascii wide nocase
		$s96 = "jiidiaalihmmhddjgbnbgdfflelocpak" ascii wide nocase
		$s97 = "knhkeligkfmclgkeedceenpopaleokfh" ascii wide nocase
		$s98 = "agoakfejjabomempkjlepdflaleeobhb" ascii wide nocase
		$s99 = "lgmpcpglpngdoalbgeoldeajfclnhafa" ascii wide nocase
		$s100 = "opcgpfmipidbgpenhmajoajpbobppdil" ascii wide nocase
		$s101 = "nphplpgoakhhjchkkhmiggakijnkhfnd" ascii wide nocase
		$s102 = "bkklifkecemccedpkhcebagjpehhabfb" ascii wide nocase
		$s103 = "eajafomhmkipbjmfmhebemolkcicgfmd" ascii wide nocase
		$s104 = "ebfidpplhabeedpnhjnobghokpiioolj" ascii wide nocase
		$s105 = "lccbohhgfkdikahanoclbdmaolidjdfl" ascii wide nocase
