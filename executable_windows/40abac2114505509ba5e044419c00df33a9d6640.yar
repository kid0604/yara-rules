...
rule danabot_main
{
	...
	strings:
		...
		$w2 = "82BD0E67-9FEA-4748-8672-D5EFE5B779B0" wide
	...
	condition:
		uint16(0)==0x5a4d and filesize >4000KB and filesize <25000KB and pe.imphash()=="908afa7baa08116e817d0ade28b27ef3" and 4 of them
}
