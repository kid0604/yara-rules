...
rule malware_Doraemon
{
	...
	condition:
		( uint16(0)==0x5A4D) and ( filesize <1MB) and pe.imports("gdi32.dll","BitBlt") and pe.imports("kernel32.dll","EncodePointer") and pe.imports("kernel32.dll","ReadConsoleW") and pe.imports("kernel32.dll","ReadConsoleW") and (pe.characteristics&pe.DLL) and all of them
}
